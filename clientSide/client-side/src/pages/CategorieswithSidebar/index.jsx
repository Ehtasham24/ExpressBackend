...
//     navigate("/Report"); // Redirect to the Sales Data Component
//   };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="System created using create-react-app"
        />
      </Helmet>

      {/*  ADD PRODUCT MODAL */}
      <AddProductModal handleModalHide={() => setOpen(false)} />

      {/*  DELETE PRODUCT MODAL */}
      <DeleteProductModal deleteModalHide={() => setOpen(false)} />

      {/* UPDATE PRODUCT MODAL */}
      <UpdateProductModal updateModalHide={() => setOpen(false)} />

      <div className="flex flex-col items-center justify-start w-full bg-white-A700">
        <Header className="flex flex-row justify-between items-center w-full p-6 sm:p-5 bg-white-A700" />

        <div className="flex flex-col items-center justify-start w-full mt-8 gap-14 md:px-5 max-w-[1636px] relative">
          <Heading as="h1">Categories</Heading>
          <div className="flex flex-row md:flex-col justify-start items-start w-full gap-8 md:gap-5">
            <div className="flex flex-col items-center justify-start w-[16%] md:w-full gap-4">
              <div className="flex flex-col items-start justify-start w-full gap-[29px]">
                <div className="flex flex-col gap-5 justify-between items-center w-full">
                  ...
                  <Text as="p" className="!text-gray-800 text-lg">
                    <button
                      className="block text-white-A700 bg-gray-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-7 py-2.5 text-center"
                      type="button"
