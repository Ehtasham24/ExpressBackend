...
//   clearCart,
// } from "../cartRedux/cartSlice";
// import Receipt from "./reciept"; // Import the Receipt component

// function CartCheckout({ isCartOpen, closeCheckout }) {
//   const cart = useSelector((state) => state.cart.carts);
//   const dispatch = useDispatch();
//   const [checkoutComplete, setCheckoutComplete] = React.useState(false); // State to manage checkout completion
...
//       console.log(responses);
//       dispatch(clearCart());
//       setCheckoutComplete(true); // Set checkout complete to true
//       alert(
//         `Total amount for checkout: PKR ${subtotal}\nProducts sold successfully!`
//       );
//     } catch (error) {
...
//   const subtotal = calculateSubtotal(); // Calculate subtotal for use in Receipt
...
//                     {/* Show receipt if checkout is complete */}
//                     {checkoutComplete && (
//                       <div className="p-4">
//                         <Receipt cart={cart} subtotal={subtotal} />
//                       </div>
//                     )}
//                   </div>
//                 </div>
